...
addSbtPlugin("com.miodx.sbt.plugins" % "sbt-s3-resolver"    % "0.19.0")  // https://github.com/ohnosequences/sbt-s3-resolver
addSbtPlugin("com.miodx.sbt.plugins" % "sbt-github-release" % "0.7.1")   // https://github.com/ohnosequences/sbt-github-release
